...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 1,
      consts: [[1, "wrapper"], ["class", "button", 3, "click", 4, "ngIf"], [1, "shell"], [1, "title"], [1, "img-wrapper"], ["src", "assets/svg/under_construction.svg", "alt", ""], [1, "img-title"], [1, "button", 3, "click"]],
    ...
    var ObxLoaderService = /*#__PURE__*/function () {
      ...
      _createClass(ObxLoaderService, [{
        ...
        value: function getObject(obxName) {
          switch (obxName) {
            case ObxNames.WORLD:
              if (src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].production) return "https://tygro101.github.io/planet-conquer/assets/3ds/worlds/login-planet.glb";else return "/assets/3ds/worlds/login-planet.glb";
